...
export default function FooterSection({
  logo = <img src="/logo.svg" alt="adaptiserv Logo" width={40} height={40} className="rounded-full" />,
  name = "adaptiserv",
  columns = [
    {
      title: "Product",
  ...
  copyright = "© 2025 adaptiserv. All rights reserved",
  policies = [
  ...
  return (
    <footer className={cn("bg-transparent w-full px-4")}>
